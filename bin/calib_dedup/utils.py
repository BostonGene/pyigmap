...
def generate_consensus(in_fq1: str, in_fq2: str, cluster_file: str,
    ...
    fq1_cons_prefix, fq2_cons_prefix = tempfile.NamedTemporaryFile(dir=TMP_DIR).name, tempfile.NamedTemporaryFile(dir=TMP_DIR).name
...
def cluster_umi(in_fq1: str, in_fq2: str, fq1_umi_len: int, fq2_umi_len: int,
    ...
    output_prefix = tempfile.NamedTemporaryFile(dir=TMP_DIR).name
...
def decompress(gz_file: str) -> str:
    ...
    output_file = tempfile.NamedTemporaryFile(dir=TMP_DIR).name
