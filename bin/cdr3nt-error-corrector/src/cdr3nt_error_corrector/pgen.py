...
class PgenModel:
    ...
    def get_pgen(self, cdr3_aa: list[str]) -> list[float | None]:
    ...
    def calculate_pgen(self, cdr3_aa: str) -> float | None:
    ...
    def _get_data_class_for_locus(self) -> load_model.GenomicDataVDJ | load_model.GenomicDataVJ:
    ...
    def get_olga_model(self) -> GenerationProbabilityVDJ | GenerationProbabilityVJ | None:
