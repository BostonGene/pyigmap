...
* Move most of the functions from `run.py` to `utils.py` (for compatibility with internal bicbucket repository) ([#28](https://github.com/BostonGene/pyigmap/issues/28))
